...
[sig,sig_c]=stc(xm(:,1:3,3));
figure,plot(freq,[psd,sig,sig_c],'linewidth',2); 
legend({'Real spectra','Fitted spectra','1/f','p1','p2','p3'});xlabel('Frequencies'),ylabel('PSD');set(gca,'fontsize',12);
